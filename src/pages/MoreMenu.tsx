...
import {
  ...
  BookOpen, Bell, Store, Settings, Coffee
} from 'lucide-react';
...
const menuItems = [
  ...
  { to: '/tasks', icon: ClipboardCheck, label: '체크리스트', color: 'text-warning' },
  { to: '/reports', icon: FileText, label: '일지/보고서', color: 'text-success' },
  { to: '/sales', icon: TrendingUp, label: '매출', color: 'text-primary' },
  { to: '/service-notes', icon: Users, label: '고객 노트', color: 'text-accent' },
